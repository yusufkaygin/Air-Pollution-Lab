...
const testDataset: BursaDataset = {
  ...
  meteoTimeSeries: [
    { stationIdOrGridId: 'a', timestamp: '2024-01-15T00:00:00Z', temperatureC: 10, humidityPct: 70, windSpeedMs: 2, windDirDeg: 180, surfacePressureHpa: 1014, precipitationMm: 0, source: 'test' },
    { stationIdOrGridId: 'a', timestamp: '2024-02-15T00:00:00Z', temperatureC: 12, humidityPct: 65, windSpeedMs: 3, windDirDeg: 200, surfacePressureHpa: 1011, precipitationMm: 0, source: 'test' },
    { stationIdOrGridId: 'a', timestamp: '2024-03-15T00:00:00Z', temperatureC: 15, humidityPct: 60, windSpeedMs: 4, windDirDeg: 210, surfacePressureHpa: 1008, precipitationMm: 0, source: 'test' },
    { stationIdOrGridId: 'b', timestamp: '2024-01-15T00:00:00Z', temperatureC: 8, humidityPct: 72, windSpeedMs: 3, windDirDeg: 170, surfacePressureHpa: 1016, precipitationMm: 1, source: 'test' },
    { stationIdOrGridId: 'b', timestamp: '2024-02-15T00:00:00Z', temperatureC: 11, humidityPct: 68, windSpeedMs: 4, windDirDeg: 195, surfacePressureHpa: 1012, precipitationMm: 0, source: 'test' },
    { stationIdOrGridId: 'b', timestamp: '2024-03-15T00:00:00Z', temperatureC: 14, humidityPct: 62, windSpeedMs: 5, windDirDeg: 205, surfacePressureHpa: 1009, precipitationMm: 0, source: 'test' },
  ],
  contextMetrics: [
